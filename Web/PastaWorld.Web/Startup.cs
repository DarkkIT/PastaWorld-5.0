namespace PastaWorld.Web
{
    ...
    using PastaWorld.Services.Data.SiteSettings;
                ...
                endpoints =>
                    {
                        ...
                        endpoints.MapControllerRoute("default", "{controller=Home}/{action=Index}/{id?}/{name?}");
